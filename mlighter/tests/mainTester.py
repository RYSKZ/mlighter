...
session.uploadCodeTemplate(
    language="python",
    fileName="/home/hector/mlighter/test/example/sklearnLogRegTest.py",
)
session.uploadCodeInput(
    fileName="/home/hector/mltest/pythonTest/inputLogReg/inputLogReg.bin.npy"
)
